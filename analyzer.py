...
class LicitacaoAnalyzer:
    ...
    def analyze(
        ...
        fragilidades = self._build_weaknesses(estrutura_notes, cobertura_notes, prova_notes, edital_notes, contrarrazao.text)
    ...
    def _build_weaknesses(self, *note_groups, contrarrazao_text: str) -> List[str]:
        weaknesses: List[str] = []
